...
class CosmosUpgradeV1beta1Plan(object):
    ...
    def __init__(self, name=None, time=None, height=None, info=None, upgraded_client_state=None):  # noqa: E501
        """CosmosUpgradeV1beta1Plan - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._time = None
        self._height = None
        self._info = None
    ...
    @property
    def name(self):
        """Gets the name of this CosmosUpgradeV1beta1Plan.  # noqa: E501
        ...
        :return: The name of this CosmosUpgradeV1beta1Plan.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CosmosUpgradeV1beta1Plan.

        Sets the name for the upgrade. This name will be used by the upgraded version of the software to apply any special \"on-upgrade\" commands during the first BeginBlock method after the upgrade is applied. It is also used to detect whether a software version can handle a given upgrade. If no upgrade handler with this name has been set in the software, it will be assumed that the software is out-of-date when the upgrade Time or Height is reached and the software will exit.  # noqa: E501

        :param name: The name of this CosmosUpgradeV1beta1Plan.  # noqa: E501
        :type: str
        """
    ...
    @property
    def time(self):
        """Gets the time of this CosmosUpgradeV1beta1Plan.  # noqa: E501
        ...
        :return: The time of this CosmosUpgradeV1beta1Plan.  # noqa: E501
        :rtype: datetime
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this CosmosUpgradeV1beta1Plan.

        Deprecated: Time based upgrades have been deprecated. Time based upgrade logic has been removed from the SDK. If this field is not empty, an error will be thrown.  # noqa: E501

        :param time: The time of this CosmosUpgradeV1beta1Plan.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def info(self):
        """Gets the info of this CosmosUpgradeV1beta1Plan.  # noqa: E501


        :return: The info of this CosmosUpgradeV1beta1Plan.  # noqa: E501
        :rtype: str
        """
        return self._info
    ...
    @info.setter
    def info(self, info):
        """Sets the info of this CosmosUpgradeV1beta1Plan.


        :param info: The info of this CosmosUpgradeV1beta1Plan.  # noqa: E501
        :type: str
        """
    ...
    def upgraded_client_state(self):
        """Gets the upgraded_client_state of this CosmosUpgradeV1beta1Plan.  # noqa: E501
        ...
        :return: The upgraded_client_state of this CosmosUpgradeV1beta1Plan.  # noqa: E501
    ...
    def upgraded_client_state(self, upgraded_client_state):
        """Sets the upgraded_client_state of this CosmosUpgradeV1beta1Plan.

        Deprecated: UpgradedClientState field has been deprecated. IBC upgrade logic has been moved to the IBC module in the sub module 02-client. If this field is not empty, an error will be thrown.  # noqa: E501

        :param upgraded_client_state: The upgraded_client_state of this CosmosUpgradeV1beta1Plan.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CosmosUpgradeV1beta1Plan, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CosmosUpgradeV1beta1Plan):
            return False
