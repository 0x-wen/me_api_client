...
class CosmosGovV1VotingParams(object):
    ...
    def __init__(self, voting_period=None):  # noqa: E501
        """CosmosGovV1VotingParams - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CosmosGovV1VotingParams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CosmosGovV1VotingParams):
            return False
