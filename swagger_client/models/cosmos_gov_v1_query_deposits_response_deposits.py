...
class CosmosGovV1QueryDepositsResponseDeposits(object):
    ...
    def __init__(self, proposal_id=None, depositor=None, amount=None):  # noqa: E501
        """CosmosGovV1QueryDepositsResponseDeposits - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CosmosGovV1QueryDepositsResponseDeposits, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CosmosGovV1QueryDepositsResponseDeposits):
            return False
